...
// Smart pointers, on the other hand, are data structures that act like a pointer but 
// also have additional metadata and capabilities.
...
// You’ll use Box Smart pointers most often in these situations:
